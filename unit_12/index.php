...
<div class="container">
    ...
    <section>
        ...
        <?php
        echo '<pre>';
        print_r(t2('./one/book1.json'));
        echo '</pre>';
        ?>
    </section>
    <section>
        <p><b>Task 3.</b></p>
        <p>Создать функцию t3, принимает парамет - путь к файлу json (cvs) и возвращает только элементы колонки color через пробел. Т.е. строку типа red green blue.</p>
        <?php
        echo '<pre>';
    ...
    <section>
        <p><b>Task 4.</b></p>
        <p>Создать функцию t4, которая принимает параметр - массив и имя ( расположение) файла. Создает файл json и записывает в него массив.</p>
        <?php
        echo '<pre>';
        $arr = [ [4,5,6], [7,8,9]];
    ...
    <section>
        <p><b>Task 5.</b></p>
        <p>Создать функцию t5, которая принимает параметр - путь к файлу json и возвращает количество записей в нем.</p>
        <?php
        echo '<pre>';
