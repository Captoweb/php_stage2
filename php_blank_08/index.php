...
<div class="container">
    ...
    <section>
        <p><b>Task 9.</b></p>
        <p>Создать функцию t9, которая выводит на страницу и возвращает первый встреченный в массиве элемент меньше (больше) нуля, после чего прекращает свою работу. </p>
        <?php
        echo '<pre>';
