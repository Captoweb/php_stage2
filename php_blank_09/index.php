...
<div class="container">
    ...
    <section>
        ...
        <?php
        echo '<pre>';
        var_dump(t2(4, [4,5,3,5,4,2,4]));
        echo '</pre>';
        ?>
    </section>
    <section>
        <p><b>Task 3.</b></p>
        <p>Создать функцию t3, принимает число и массив и возвращает количество элементов массива меньше указанного.</p>        
        <?php
        echo '<pre>';
        var_dump(t3(4, [4,5,3,5,4,2,3]));
        echo '</pre>';
        ?>
    </section>
    <section>
    ...
    <section>
        ...
        <?php
        echo '<pre>';
        var_dump(t5('even', [1, 3, 5, 7, 9, 11, 13, 15, 2, 4, 6]));
        echo '</pre>';
        ?>
    </section>
